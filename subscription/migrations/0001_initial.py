    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ref_transaction_number', models.CharField(blank=True, max_length=367, null=True)),
                ('due_date', models.DateTimeField()),
                ('status_term', models.CharField(blank=True, max_length=39, null=True)),
                ('invoice_ref_number', models.CharField(default='INV-REF-63743792', editable=False, max_length=39)),
                ('is_active', models.BooleanField(default=False)),
                ('update_log', models.DateTimeField(auto_now=True)),
                ('is_reconcile', models.BooleanField(default=False)),
                ('transaction_status_term', models.CharField(blank=True, max_length=39, null=True)),
                ('subscription_type_term', models.CharField(blank=True, max_length=39, null=True)),
                ...
                ('ref_client_subscription', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='subscription.clientsubscription')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='Subscription',
            fields=[
                ('order_number', models.PositiveIntegerField(auto_created=True, editable=False, unique=True)),
                ...
                ('name', models.CharField(max_length=69)),
                ('short_description', models.CharField(blank=True, max_length=361, null=True)),
                ('detail_description', models.TextField()),
                ('subscription_image', models.FileField(blank=True, null=True, upload_to='media/images/subscription_images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=False)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('upto_corporate_group_term', models.CharField(blank=True, max_length=67, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='client.client')),
                ('client_subscription', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='subscription.clientsubscription')),
                ('subscription', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='subscription.subscription')),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            ...
            name='subscription',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='subscription.subscription'),
        ),
    ]
